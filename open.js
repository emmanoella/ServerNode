...
res.writeHead(200,{"Content-Type":"text/html"}); //text/css,text/html,text/plain,image/jpeg,video/mp4,application/zipce sont les types de donnée que le serveur devra indiquer qu'ilapprete à envoyer au client
